        ...
        if (burger.isDevoured) {
            ...
            return `<div class="row d-flex justify-content-center">
                            ...
                            <div class="col-4 col-md-5 col-lg-4">
                                <button class="btn-sm btn-warning devour-btn-js" id="${burger.id}" type="submit"> Devour it!</button>
                            </div>
                        </div>`;
        }
    });
...
function getDevourBtns(){
    const devourBtns = document.querySelectorAll(".devour-btn-js");
    for (let i = 0; i < devourBtns.length; i++){
        devourBtns[i].addEventListener("click", function (){
            console.log("devour btn id: ", event.target.id);
        });
    }
}
getDevourBtns();